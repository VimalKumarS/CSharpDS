...
/*
  Min-heap property means that key of every child node should be greater 
 * or equal to the key of parent node. Max-heap property means that the key o
 * f every child node should be less or equal to the key of parent node.
 */
